...
@section('main-content')
    ...
    {{-- @php
        ...
        $sizes = $sizes->flatMap(function ($size) {
                return explode(',', $size);})
            ->unique()
            ->values()
            ->all();
                                ...
                                <div class="price-filter">
                                    <div class="price-filter-inner">
                                        @php
                                            ...
                                            // dd($max);
                                        @endphp
                                        <div id="slider-range" data-min="{{ $min }}"
                                            data-max="{{ $max }}"></div>
                                    ...
                                    <div class="shop-shorter">
                                        <div class="single-shorter">
                                            ...
                                            <select class="show" name="show" onchange="this.form.submit();">
                                                ...
                                                <option value="5" @if (!empty($_GET['show']) && $_GET['show'] == '5') selected @endif>05
                                                </option>
                                                <option value="10" @if (!empty($_GET['show']) && $_GET['show'] == '10') selected @endif>10
                                                </option>
